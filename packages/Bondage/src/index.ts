...
export class ZapBondage extends BaseContract {
    ...
    async bond({provider, endpoint, zapNum, from, gas=Utils.Constants.DEFAULT_GAS}:BondArgs) {
    ...
    async unbond({provider, endpoint, dots, from, gas=Utils.Constants.DEFAULT_GAS}:UnbondArgs) {
